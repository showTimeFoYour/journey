            ...
            <div class="res-inf" id="baseInfoForm">
                ...
                <div class="user-int clearfix">
                    <div class="form-sec flt1" style="clear: both">
                        <h>卖点标题</h>
                        <input id="title" name ="title" id="title" type="text" class="bord-red"  value="哈尔冰三日游" data-required="" data-title="订单标题">
                        <span id="msg3"></span>
                    </div>
                    <div class="form-sec flt1" style="clear: both">
                        ...
                        <div class="parentCls">
                            <h>具体人数</h>
                            <input  name ="num" id="num" type="number" min="1" max="5" class="bord-red"  value="1" data-required="" data-title="人数">
                    ...
                    <div class="ver-code clearfix">
                        <p class="form-sec flt1">
                            ...
                            <input  name="price" id="price" type="text" placeholder="价格" value="1999" data-required="1" data-title="价格">
                            <span id="msg5"></span>
                        </p>
                    </div>
                   <div class="ver-code clearfix">
